    ...
    private void updateAccentSummary() {
        if (mAccentPicker != null) {
            if (Utils.isThemeEnabled("com.android.theme.color.space")) {
                ...
                mAccentPicker.setSummary(mContext.getString(R.string.accent_colors_scorpiongreen));
            } else if (Utils.isThemeEnabled("com.android.theme.color.scorpionpurple")) {
                mAccentPicker.setSummary(mContext.getString(R.string.accent_colors_scorpionpurple));
            } else if (Utils.isThemeEnabled("com.android.theme.color.scorpionred")) {
                mAccentPicker.setSummary(mContext.getString(R.string.accent_colors_scorpionred));
            } else {
